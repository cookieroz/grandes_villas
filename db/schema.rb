...
ActiveRecord::Schema.define(:version => 20120927201557) do
  ...
  create_table "spud_photo_albums_photos", :id => false, :force => true do |t|
  ...
  create_table "spud_photo_galleries_albums", :id => false, :force => true do |t|
